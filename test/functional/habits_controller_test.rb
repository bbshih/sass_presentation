...
class HabitsControllerTest < ActionController::TestCase
  ...
  test "should create habit" do
    assert_difference('Habit.count') do
      post :create, habit: { completed: @habit.completed, description: @habit.description, name: @habit.name }
    end
  ...
  test "should update habit" do
    put :update, id: @habit, habit: { completed: @habit.completed, description: @habit.description, name: @habit.name }
    assert_redirected_to habit_path(assigns(:habit))
  end
